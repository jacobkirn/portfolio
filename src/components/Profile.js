        ...
        <section id="profile-section">
            <div className='container'>
                ...
                <div className='row' id="profile-text-m">
                    <h3>User Experience graduate student at Michigan State University. Currently solving warehouse automation problems at <a href="https://www.dematic.com/" target='_blank' rel="noreferrer">Dematic</a>. Practiced in design, development, and documentation. Interested in all sorts of creative things.</h3>
                </div>
